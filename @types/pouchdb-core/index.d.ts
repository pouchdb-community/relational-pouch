...
declare namespace PouchDB {
    namespace Core {
        ...
        interface AllDocsResponse<Content extends {}> {
            ...
            rows: Array<{
                ...
                doc?: ExistingDocument<Content & AllDocsMeta> | null;
                id: DocumentId;
                key: DocumentKey;
                value: {
                    rev: RevisionId;
        ...
        interface AllDocsKeysResponse<Content extends {}> {
            /** The `skip` if provided, or in CouchDB the actual offset */
            offset: number;
            total_rows: number;
            update_seq?: number | string;
    ...
    interface Database<Content extends {} = {}> extends EventEmitter {
        ...
        allDocs<Model>(options: Core.AllDocsWithKeysOptions): Promise<Core.AllDocsKeysResponse<Content & Model>>;
